  ...
  return (
    <Fragment>
      {userInformation.map((user) => {
        ...
        const individualLink = `https://www.megahoot.net/${username}/hoot/${btoa(
          hootId
        )}/${uuidv4()}`;
                  ...
                  <div className="post-heading">
                    ...
                    >
                      <Link to={path}>
                        <div className="avatar-wraper">
                          <Avatar
                            ...
                            src={profilePicPath}
                            className={
                              user.profilePic === null ? null : "skeleton-img"
                            }
                          />
                        </div>
                      </Link>
                      <div>
                        ...
                        {user.designation && user.designation === "Official" ? (
                          <div
                            style={{
                              display: "flex",
                              alignItems: "center",
                          ...
                          user.designation.includes("Media") ? (
                          <div
                            style={{
                              display: "flex",
                              alignItems: "center",
                          ...
                          user.designation.includes("Corporate") ? (
                          <div
                            style={{
                              display: "flex",
                              alignItems: "center",
                          ...
                          user.designation.includes("Adult") ? (
                          <div
                            style={{
                              display: "flex",
                              alignItems: "center",
                          ...
                          user.designation.includes("Goverment") ? (
                          <div
                            style={{
                              display: "flex",
                              alignItems: "center",
                          ...
                          user.designation.includes("Club") ? (
                          <div
                            style={{
                              display: "flex",
                              alignItems: "center",
                          ...
                          user.designation &&
                          user.designation.includes("Parody") && (
                            <div
                              style={{
                                display: "flex",
                                alignItems: "center",
                    ...
                    {hoverInfo && (
                      ...
                      >
                        ...
                        <div className="hoot-user-info">
                          ...
                          <div className="user-bio-hover">{user.bio}</div>
                        </div>
                      </div>
                    )}
