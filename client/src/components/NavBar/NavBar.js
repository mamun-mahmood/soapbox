    ...
    <nav className="main-nav shadow-sm" style={{ zIndex: "11111" }}>
      ...
      >
        ...
        {userData && userData.privateChannel && privateUserImage ? (
          <SoapboxTooltip
            title={showExtraFeatures ? "Hide Profile" : "Show Profile"}
            placement="bottom"
          >
            <div
            ...
            >
              <img src={privateUserImage} alt="" />
            </div>
          </SoapboxTooltip>
        ) : null}

        <ul
          className="main-list-inline"
          id={showLinks ? (height ? "private-main-hidden" : "main-hidden") : ""}
        >
          {localStorage.getItem("loggedIn") ? (
            <Fragment>
              {userData.privateChannel && header ? null : (
                <NavLink
                  activeClassName=""
              ...
              {userData && userData.privateChannel && header ? null : (
                <Link
                  // activeClassName="nav-link-active"
                  activeClassName=""
                  className="nav-link main-title"
