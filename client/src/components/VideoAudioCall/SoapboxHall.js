...
function Stop() {
    if (participants[myarray[0]].rtcPeer) {
...
render(){
     return (
        ...
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',flexDirection:'column'}}>
          <div id="meetingRoomHeader" onMouseEnter={()=>{this.setState({showControlls:false})}} ><h3>{"Aakash's Live Experience"}</h3><h5>{"POWERED BY VEROHIVE"}</h5></div>
